...
try: app_id = int(os.environ.get("app_id", "25275937"))
except Exception as app_id: print(f"⚠️ App ID Invalid {app_id}")
try: api_hash = os.environ.get("api_hash", "9db6a78c83443e670d3beccc6004f155")
except Exception as api_id: print(f"⚠️ Api Hash Invalid {api_hash}")
try: bot_token = os.environ.get("bot_token", "7432639282:AAHtlrTS4bXrqGJW4el1vt-7EEWqVL8fGso")
except Exception as bot_token: print(f"⚠️ Bot Token Invalid {bot_token}")
try: custom_caption = os.environ.get("custom_caption", "`{file_name}`Main @darkangel_db")
...
about_message = """
<b>• Name : <a href=https://t.me/darkangel_db>MG AutoCaption</a></b>
<b>• Developer : <a href=https://t.me/darkangel_db>[Darkangel UPDATES]</a></b>
<b>• Language : Python3</b>
<b>• Library : Pyrogram v{version}</b>
<b>• Updates : <a href=https://t.me/darkangel_db>Click Here</a></b>
...
def start_buttons(bot, update):
  bot = bot.get_me()
  buttons = [[
   pyrogram.types.InlineKeyboardButton("Updates", url="t.me/darkangel_db"),
   pyrogram.types.InlineKeyboardButton("About 🤠", callback_data="about")
   ],[
   pyrogram.types.InlineKeyboardButton("➕️ Add To Your Channel ➕️", url=f"http://t.me/MgAutoCaption_Bot?startchannel=true")
   ]]
...
print("Bot Created By https://t.me/darkangel_db")
